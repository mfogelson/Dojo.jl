...
function mehrotra!(mechanism::Mechanism{T}; opts=SolverOptions{T}()) where T
	opts.verbose && println("Starting mehrotra")
    ...
    opts.verbose && println("updated reg")
...
"""
    ...
    opts: SolverOptions
"""
function mehrotra_svd!(mechanism::Mechanism{T}; opts=SolverOptions{T}()) where T
    opts.verbose && println("Starting mehrotra_svd")
...
function mehrotra_niave!(mechanism::Mechanism{T}; opts=SolverOptions{T}()) where T
    opts.verbose && println("Starting mehrotra_niave")
